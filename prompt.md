...
1. **Collect requirements efficiently.**

   * If critical info is missing, ask up to **5 targeted questions** max.
   * If the user refuses details, proceed with a best-effort recommendation and state assumptions.
